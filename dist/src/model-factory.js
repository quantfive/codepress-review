 ...
 */
function validateReasoningEffort(modelName, reasoningEffort) {
    if (reasoningEffort === "none") {
        const isGpt51 = modelName.toLowerCase().includes("gpt-5.1");
        if (!isGpt51) {
            throw new Error(`reasoningEffort 'none' is only available for GPT-5.1 models. ` +
 ...
 */
function buildModelSettings(config) {
