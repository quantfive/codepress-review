...
import type { DiffSummary, Finding, ModelConfig } from "./types";
/**
 ...
 */
export declare function summarizeDiff(chunks: ProcessableChunk[], modelConfig: ModelConfig, existingReviews?: any[], existingComments?: any[], blockingOnly?: boolean): Promise<DiffSummary>;
/**
