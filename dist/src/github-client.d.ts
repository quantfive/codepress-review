import type { Finding, GitHubConfig, DiffSummary, ModelConfig } from "./types";
/**
...
export declare class GitHubClient {
     ...
     */
    updatePRDescription(prNumber: number, description: string): Promise<boolean>;
    /**
     ...
     */
    getExistingReviews(prNumber: number): Promise<{
        id: number;
        node_id: string;
        user: {
            name?: string | null;
     ...
     */
    createReview(prNumber: number, commitId: string, findings: Finding[], diffSummary?: DiffSummary): Promise<void>;
    private findReviewThread;
    private resolveReviewThreadById;
    /**
     ...
     */
    resolveReviewComment(prNumber: number, commentId: number, reason: string): Promise<void>;
}
