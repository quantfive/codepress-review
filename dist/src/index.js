...
async function run() {
    try {
        ...
        const diffFile = (0, node_path_1.resolve)("pr.diff");
        let commitSha;
        try {
            ...
            (0, node_fs_1.writeFileSync)(diffFile, diffOutput);
            ...
            try {
                ...
                core.info(`Found ${existingComments.length} existing review comments from other reviewers`);
            }
            catch (commentError) {
