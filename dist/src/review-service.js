...
class ReviewService {
    ...
    async processChunk(chunk, chunkIndex, existingComments) {
        ...
        try {
            const modelConfig = (0, config_1.getModelConfig)();
            findings = await (0, ai_client_1.callWithRetry)(() => (0, agent_1.reviewChunkWithAgent)(chunk.content, modelConfig, this.diffSummary, chunkIndex, this.repoFilePaths, this.config.maxTurns), chunkIndex + 1);
        }
        catch (error) {
