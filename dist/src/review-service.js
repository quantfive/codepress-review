...
class ReviewService {
    ...
    async execute() {
        ...
        try {
            await (0, agent_1.reviewFullDiff)(modelConfig, this.repoFilePaths, prContext, maxTurns, this.config.blockingOnly, existingComments, botPreviousComments, relatedRepos);
