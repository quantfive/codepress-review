...
exports.allTools = exports.todoTool = exports.bashTool = exports.searchRepoTool = exports.depGraphTool = exports.fetchSnippetTool = exports.fetchFilesTool = void 0;
...
This helps you stay organized and not forget important steps.`,
    parameters: zod_1.z.object({
        ...
        tasks: zod_1.z
            .array(zod_1.z.string())
            .optional()
            .describe("Array of task descriptions (for 'add' action to add multiple tasks at once)"),
    }),
    execute: async ({ action, task, tasks }) => {
        switch (action) {
            ...
            case "done": {
                if (!task)
                    return "Error: task description required for 'done' action";
...
exports.allTools = [exports.bashTool, exports.depGraphTool, exports.todoTool];
