...
exports.allTools = exports.completeReviewTool = exports.webSearchTool = exports.webFetchTool = exports.todoTool = exports.bashTool = exports.searchRepoTool = exports.depGraphTool = exports.fetchSnippetTool = exports.fetchFilesTool = void 0;
 ...
 */
exports.completeReviewTool = (0, agents_1.tool)({
...
This tool TERMINATES the review loop - do not call it until you are truly done.`,
    parameters: zod_1.z.object({
        verdict: zod_1.z
            ...
            .describe("The review verdict you submitted. Use NONE only if you couldn't submit a review."),
        summary: zod_1.z
            .string()
