 ...
 */
export declare function reviewFullDiff(fullDiff: string, modelConfig: ModelConfig, repoFilePaths: string[], prContext: PRContext, maxTurns?: number, blockingOnly?: boolean): Promise<void>;
