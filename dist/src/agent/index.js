        ...
        if (hunkSummary) {
            ...
            if (hunkSummary.issues.length > 0) {
                ...
                hunkSummary.issues.forEach((issue) => {
                    contextLines.push(`      <issue severity="${(0, xml_utils_1.escapeXml)(issue.severity)}" kind="${(0, xml_utils_1.escapeXml)(issue.kind)}">${(0, xml_utils_1.escapeXml)(issue.description)}</issue>`);
                });
                contextLines.push("    </issues>");
            }
