...
`);
    ...
    describe("execute", () => {
        ...
        it("should pass blockingOnly flag to agent", async () => {
            ...
            await service.execute();
            expect(agent.reviewFullDiff).toHaveBeenCalledWith(expect.any(String), expect.any(Object), expect.any(Array), expect.any(Object), 20, true, // blockingOnly should be true
            []);
        });
