...
describe("GitHubClient", () => {
    ...
    beforeEach(() => {
        ...
        client = new github_client_1.GitHubClient(githubConfig, modelConfig);
    ...
    describe("resolveReviewComment", () => {
        ...
        it("should update comment and resolve thread when found on first page", async () => {
            ...
            mockOctokit.graphql.mockResolvedValue(graphqlResponse);
            // Act
            ...
            expect(mockOctokit.graphql).toHaveBeenCalledWith(expect.stringContaining("FindReviewThread"), expect.anything());
            // Check that the resolve thread mutation was called
            expect(mockOctokit.graphql).toHaveBeenCalledWith(expect.stringContaining("ResolveReviewThread"), { threadId });
        });
        it("should handle pagination to find the correct thread", async () => {
            ...
            expect(mockOctokit.graphql).toHaveBeenCalledWith(expect.stringContaining("FindReviewThread"), expect.objectContaining({ after: "cursor-1" }));
        ...
        it("should not try to resolve a thread if it is not found", async () => {
            ...
            expect(mockOctokit.graphql).not.toHaveBeenCalledWith(expect.stringContaining("ResolveReviewThread"), expect.anything());
        });
