      ...
      <item>Verify documentation accuracy</item>
            ...
            expect(generateText).toHaveBeenCalledWith({
                ...
                messages: [
                    {
                        role: "user",
                        content: expect.stringContaining('<chunk index="0" file="src/example.ts">'),
                    },
                ],
            });
        });
        it("should handle file-based custom prompt in summarizeDiff", async () => {
            ...
            expect(require("../src/summary-agent-system-prompt").getSummarySystemPrompt).toHaveBeenCalledWith();
        });
