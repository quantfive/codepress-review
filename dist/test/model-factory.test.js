...
describe("createModel", () => {
    ...
    it("should create models for all supported providers", async () => {
        ...
        const { createModel } = await Promise.resolve().then(() => __importStar(require("../src/model-factory")));
    ...
    it("should throw error for unsupported provider", async () => {
        ...
        await expect(createModel(config)).rejects.toThrow("Unsupported MODEL_PROVIDER: unsupported");
    });
    it("should throw error for openai-compatible without base URL", async () => {
        ...
        await expect(createModel(config)).rejects.toThrow("OPENAI_COMPATIBLE_BASE_URL environment variable is required");
    });
...
//# sourceMappingURL=model-factory.test.js.map