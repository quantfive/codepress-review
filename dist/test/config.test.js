...
describe("Configuration", () => {
    ...
    describe("getReviewConfig", () => {
        ...
        it("should throw error if GITHUB_TOKEN is missing", () => {
            ...
            expect(() => (0, config_1.getReviewConfig)()).toThrow("GITHUB_TOKEN environment variable is required");
        });
        it("should throw error if GITHUB_REPOSITORY is missing", () => {
            delete process.env.GITHUB_REPOSITORY;
            expect(() => (0, config_1.getReviewConfig)()).toThrow("GITHUB_REPOSITORY environment variable is required");
        });
    });
});
